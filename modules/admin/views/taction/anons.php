...
<?php
 ...
 {
?>
<p><h3>В настоящее время мы готовим для Вас новые события и выставки. Их анонсы обязательно появятся на сайте.</h3></p>
<br/>
<p><h3>Пока же предлагаем ознакомиться с <a href="<?php echo Url::to(['site/floor1']);?>">постоянными экспозициями</a> музея</h3></p>
 <!--<h2> Интересующий Вас день прошёл без новостей.</h2>--><?php
 }

?>
<a href="<?php  echo Url::to(['taction/arhiveanons']);?>"><h2> Архив анонсов</h2></a>
